          ...
          <div class="col-12 mb-4">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
              ...
              <div class="bs-stepper-content">
                <form action="{{ route('karyawan.store')}}" method="POST" onSubmit="return false">
                  @csrf
                  <!-- Account Details -->
                  <div id="account-details" class="content">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="email" name="email" id="email" class="form-control  @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="john.doe@email.com" aria-label="john.doe" />
                        @error('email')
                      ...
                      <div class="col-sm-6 form-password-toggle">
                        ...
                        <div class="input-group input-group-merge">
                          <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" required autocomplete="new-password" value="{{ old('password') }}" placeholder="********">
                  ...
                  <div id="personal-info" class="content">
                    ...
                    <div class="row g-3">
                      <div class="col-sm-6">
                        ...
                        <input type="number" name="nik" id="first-name"  value="{{ old('nik') }}" class="form-control @error('nik') is-invalid @enderror" placeholder="Nik"/>
                        @error('nik')
                        <div class="invalid-feedback">
                            nik tidak valid
                        </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="text" id="" name="nama_karyawan" class="form-control" placeholder="Nama Karyawan" value="{{ old('nama_karyawan') }}" />
                      </div>
                      <div class="col-sm-6">
                        <label for="flatpickr-date" class="form-label">Tanggal Lahir</label>
                        <input type="text" class="form-control" name="tgl_lahir" placeholder="Tahun-Bulan-Lahir" value="{{ old('tgl_lahir') }}" id="flatpickr-date" />
                      </div>
                      <div class="col-sm-6">
                        <label class="form-label" for="last-name">No Telf</label>
                        <input type="number" id="" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror" value="{{ old('no_telp') }}" placeholder="No Telf" />
                        @error('no_telp')
                        <div class="invalid-feedback">
                          no telf tidak valid
                        </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <select class="selectpicker w-100" name="jabatan" data-style="btn-transparent" value="{{ old('jabatan') }}" data-icon-base="ti" data-tick-icon="ti-check text-white">
                      ...
                      <div class="col-sm-6">
                        ...
                        <select class="selectpicker w-100" name="status_hubungan" data-style="btn-transparent" value="{{ old('status_hubungan') }}" data-icon-base="ti" data-tick-icon="ti-check text-white">
                      ...
                      <div class="col-sm-6">
                        ...
                        <select class="selectpicker w-100" name="unit_bisnis" data-style="btn-transparent" value="{{ old('unit_bisnis') }}" data-icon-base="ti" data-tick-icon="ti-check text-white">
                        ...
                        <div class="col-sm-6">
                          <div class="form-check form-check-success custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customRadioVTemp1">
                              <input name="jenis_kelamin" class="form-check-input" type="radio" value="pria" {{ old('jenis_kelamin') == 'pria' ? 'checked' : '' }} id="customRadioVTemp1" checked />
                        ...
                        <div class="col-md">
                          <div class="form-check form-check-success custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content" for="customRadioVTemp2">
                              <input name="jenis_kelamin" class="form-check-input" type="radio" value="wanita" {{ old('jenis_kelamin') == 'wanita' ? 'checked' : '' }} id="customRadioVTemp2" />
                              <span class="custom-option-header">
                      ...
                      <div class="input-group">
                        ...
                        <textarea class="form-control" aria-label="With textarea" name="alamat" placeholder="Masukan Alamat "> {{ old('alamat') }} </textarea>
                      </div>
